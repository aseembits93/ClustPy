...
class ENRC(_AbstractDeepClusteringAlgo):
    ...
    def __init__(
        ...
        self.pretrain_optimizer_params = pretrain_optimizer_params or {"lr": 1e-3}
        self.clustering_optimizer_params = clustering_optimizer_params or {"lr": 1e-4}
    ...
    def transform_subspace(
        ...
        subspace = np.dot(emb, cluster_space_V)
        return subspace
